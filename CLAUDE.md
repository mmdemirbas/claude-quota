...
6. Caches responses in `~/.claude/plugins/claude-quota/` (usage: 2 min hard / 90 s soft TTL; profile: 24 h; credit grant: 10 min when present, 24 h when null; multi-instance aware — bumps timestamp before fetch to prevent parallel fetches)
